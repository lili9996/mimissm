...
<script type="text/javascript">
	...
	function myclose(ispage) {
		...
		//window.close();
			...
			<div id="table">
				<form action="${pageContext.request.contextPath}/product/update.action" enctype="multipart/form-data" method="post" id="myform">
					...
					<table>
						...
						<!-- typeId是1，2，3。forEach循环，当type.typeId==product.typeId就会被selected选中，也就是页面中的电视处于被选中的状态，也就是页面处于回显状态，这个回显是前端页面管的，虽然调用了后端的监听器-->
						<tr>
							<td class="one">类别</td>
							<td>
								<select name="typeId">
